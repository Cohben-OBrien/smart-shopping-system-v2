...
public class ReportGenerator {
    ...
    public static void showSalesReport(List<SalesRecord> sales, JTextArea reportArea) {
    ...
    public static void showLowStockReport(List<Product> products, int limit, JTextArea reportArea) {
